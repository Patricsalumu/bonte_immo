...
<body>
    ...
    <div class="header clearfix">
        ...
        <div class="invoice-info">
            ...
            <div class="invoice-date">
                Émise le <?php echo e($facture->created_at->format('d/m/Y')); ?><br>
                Échéance : <?php echo e($facture->date_echeance->format('d/m/Y')); ?>
    ...
    <div class="client-info" style="align-items: flex-start;">
        <div class="client-col" style="vertical-align: top;">
            ...
            Tél : <?php echo e($facture->locataire->telephone); ?><br>
            <?php if($facture->locataire->email): ?> Email : <?php echo e($facture->locataire->email); ?><br> <?php endif; ?>
            <?php if($facture->locataire->adresse): ?> <?php echo e($facture->locataire->adresse); ?> <?php endif; ?>
        </div>
        <div class="client-col client-col-right" style="vertical-align: top; text-align: right; margin-top: 0;">
            ...
            Immeuble : <?php echo e($facture->loyer->appartement->immeuble->nom); ?><br>
            Appartement : N°<?php echo e($facture->loyer->appartement->numero); ?><br>
            Loyer : <?php echo e(number_format($facture->montant, 0, ',', ' ')); ?> $<br>
            Période : <?php echo e(str_pad($facture->mois, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($facture->annee); ?>
    ...
    <!-- Paiement si payé -->
    <?php if($facture->estPayee() && $facture->paiements->count() > 0): ?>
        <?php $paiement = $facture->paiements->sortByDesc('date_paiement')->first(); ?>
        <table class="details-table">
            ...
            <tr>
                ...
                <td><strong><?php echo e(number_format($facture->paiements->sum('montant'), 0, ',', ' ')); ?> $</strong></td>
            </tr>
        </table>
    <?php endif; ?>
...
<div class="guarantee-section">
     ...
     <div class="guarantee-text">
         <strong>Montant de la garantie :</strong> <?php echo e(number_format($facture->loyer->garantie_locative, 0, ',', ' ')); ?> $<br> 
    ...
    <!-- Footer -->
    <div class="footer">
        Document généré le <?php echo e($date_generation); ?> par <strong>La Bonté Immo App</strong>.
    </div>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\immo\resources\views/factures/pdf.blade.php ENDPATH**/ ?>