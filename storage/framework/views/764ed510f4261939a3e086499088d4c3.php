            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h4><?php echo e($factures->where('statut_paiement', 'non_paye')->count()); ?></h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h4><?php echo e($factures->filter(function($f) { return $f->estEnRetard(); })->count()); ?></h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h4><?php echo e($factures->filter(function($f) { return $f->estPayee(); })->count()); ?></h4>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <h4><?php echo e(number_format($factures->sum('montant'), 0, ',', ' ')); ?> CDF</h4>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function verifierDoublons() {
        ...
        fetch('<?php echo e(route("factures.verifier-doublons")); ?>', {
            method: 'POST',
            headers: {
