...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'La Bonte Immo'); ?></title>
    ...
    <nav id="sidebar" class="sidebar">
        <div class="p-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('immeubles.*') ? 'active' : ''); ?>" href="<?php echo e(route('immeubles.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('appartements.*') ? 'active' : ''); ?>" href="<?php echo e(route('appartements.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('locataires.*') ? 'active' : ''); ?>" href="<?php echo e(route('locataires.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('loyers.*') ? 'active' : ''); ?>" href="<?php echo e(route('loyers.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('paiements.*') ? 'active' : ''); ?>" href="<?php echo e(route('paiements.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('caisse.*') ? 'active' : ''); ?>" href="<?php echo e(route('caisse.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('rapports.*') ? 'active' : ''); ?>" href="<?php echo e(route('rapports.index')); ?>">
        ...
        <div class="mt-auto p-3 border-top">
            <div class="dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    ...
                    <span class="sidebar-text"><?php echo e(auth()->user()->nom); ?></span>
                </a>
                <ul class="dropdown-menu">
                    <li><span class="dropdown-item-text"><?php echo e(auth()->user()->role); ?></span></li>
