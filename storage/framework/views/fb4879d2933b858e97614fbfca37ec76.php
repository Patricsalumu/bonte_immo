...
<?php $__env->startSection('title', 'Notifications aux Locataires'); ?>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('notifications.envoyer')); ?>" id="formNotification">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3" id="div_immeuble" style="display: none;">
                        ...
                        <select name="immeuble_id" id="immeuble_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $immeubles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $immeuble): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($immeuble->id); ?>"><?php echo e($immeuble->nom); ?> - <?php echo e($immeuble->adresse); ?></option>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-2">
                    ...
                    <strong class="float-end"><?php echo e($locatairesEnRetard->count() + 50); ?></strong>
                </div>
                <div class="mb-2">
                    <small class="text-muted">Locataires en retard:</small>
                    <strong class="float-end text-danger"><?php echo e($locatairesEnRetard->count()); ?></strong>
                </div>
                <div class="mb-2">
                    <small class="text-muted">Immeubles actifs:</small>
                    <strong class="float-end"><?php echo e($immeubles->count()); ?></strong>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\immo\resources\views/notifications/index.blade.php ENDPATH**/ ?>